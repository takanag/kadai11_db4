...
<body>
    ...
    <main>
        <div class="table-container">
            ...
            echo "<tr><th>place_id</th><th>温泉名</th><th>住所</th><th>更新日時</th><th>更新</th><th>削除</th></tr>";

            foreach ($results as $row) {
                echo "<tr>";
                echo "<td>" . h($row['place_id']) . "</td>";
                echo "<td>" . h($row['place_name']) . "</td>";
                echo "<td>" . h($row['address']) . "</td>";
                echo "<td>" . h($row['created']) . "</td>";


                // 更新と削除のリンクを一列に正しく配置
                echo "<td><a href='bandai_gensen_detail.php?place_id=" . $row['place_id'] . "'>";
                echo "<img src='" . $img_update . "' alt='update' width='30' height='30'></a></td>";
                echo "<td><a href='bandai_gensen_delete.php?place_id=" . $row['place_id'] . "' onclick='return confirm(\"削除してよろしいですか？\");'>";
